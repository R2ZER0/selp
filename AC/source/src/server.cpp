...
void resetserver(const char *newname, int newmode, int newtime)
{
    ...
    /* SquareStats game_end event */
    on_event_game_end();
    /* end SquareStats event */
...
void startgame(const char *newname, int newmode, int newtime, bool notify)
{
    ...
    else
    {
        ...
        /* SquareStats event: start_game */
        /* modestrings taken from clientgame.cpp */
        static const char *modestrings[] =
        {
            "tdm", "coop", "dm", "lms", "ts", "ctf", "pf", "btdm", "bdm", "lss",
            "osok", "tosok", "bosok", "htf", "tktf", "ktf", "tpf", "tlss", "bpf", "blss", "btsurv", "btosok"
        };
        on_event_game_start(smapname, modestrings[newmode]);
        /* End SquareStats event */
    }
}
